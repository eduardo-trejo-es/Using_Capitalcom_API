...
Capital_Retriver = CapitalAPI_Retriver_Piceses_Data ('KWRSGEiHr5GjVlOz')


dates_From, DatesTo=Capital_Retriver.generateBussinesDaysrange("2022-09-23","2022-09-24")
...
Capital_Retriver.Generating_Time_colum("Twttr/DataMinuteTwttr.csv","Twttr/TimeColum.csv")
